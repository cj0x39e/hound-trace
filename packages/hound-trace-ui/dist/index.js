...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hound_trace_src_index__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__renderCallStack__ = __webpack_require__(2);
...
function renderCallback(callStack, options) {
  ...
  var _loop = function _loop() {
    ...
    if (Array.isArray(frame.next)) {
      ...
      frame.next.forEach(function (n, i) {
        graphDefinition += "\n".concat(frame.name, "-->").concat(showLable ? '|' + (i + 1) + '|' : '').concat(n.name);
        queue.push(n);
      });
    }
  };
  ...
  __WEBPACK_IMPORTED_MODULE_0_mermaid___default.a.init(undefined, element);
}
...
module.exports = "#hound_trance_mermaid_container {\n    position: fixed;\n    top: 0;\n    bottom: 0;\n    right: 0;\n    left: 0;\n    height: 100vh;\n    width: 60%;\n    background-color: #fff;\n    display: flex;\n    justify-content: center;\n    box-shadow: 0 0 5px 0px #b2b2b2;\n    z-index: 999999999999;\n}"
